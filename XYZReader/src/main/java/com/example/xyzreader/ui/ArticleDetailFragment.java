...
public class ArticleDetailFragment extends Fragment implements
    ...
    private View metaBar;
    private int[] screenLocation = {0,0};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mScrollView.setCallbacks(new ObservableScrollView.Callbacks() {
            ...
            public void onScrollChanged() {
                ...
                updateStatusBar();
                //Toggle the appearance of the appearance of the title hint
               toggleTitleHint();
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
                ...
                public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                    if(mCursor != null)
                    if ((verticalOffset == 0 || verticalOffset <= toolBar.getHeight()) && !mToolbar.getTitle().equals(mCollapsedTitle)) {
        ...
        */
        /*
        if(savedInstanceState!=null && savedInstanceState.containsKey("hintShown"))
            hintShown = savedInstanceState.getBoolean("hintShown");

        if(savedInstanceState!=null && savedInstanceState.containsKey("paused"))
    ...
    public void onSaveInstanceState(Bundle bundle){
        ...
        bundle.putBoolean("hintShown", hintShown);
        bundle.putBoolean("paused",paused);
    }

    public void toggleTitleHint(){
            ...
            if(paused && hintShown)
            {
                ...
                if (titleView == null)
                    return;
                titleView.getLocationOnScreen(screenLocation);

                if ((screenLocation[1] + titleView.getHeight()) < 0) {
                    titleHintView.setVisibility(View.VISIBLE);
                    hintShown = true;
                } else {
    ...
    */
    ...
    private void bindViews() {
        ...
        /*
        titleHintView = (TextView) mRootView.findViewById(R.id.article_title_hint);

        titleHintView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        */
        if (mCursor != null) {
            ...
            //titleHintView.setText(mCursor.getString(ArticleLoader.Query.TITLE));
                    ...
                    .get(mCursor.getString(ArticleLoader.Query.PHOTO_URL), new ImageLoader.ImageListener() {
                        ...
                        public void onResponse(ImageLoader.ImageContainer imageContainer, boolean b) {
                            ...
                            if (bitmap != null) {
                                ...
                                //titleHintView.setBackgroundColor(mMutedColor);
                                //toggleTitleHint();
                                //updateStatusBar();
                            }
                        }
